import { IEventEmitter } from "@oss-stealth/utils/dist/co/emitter";

export interface IRouteHandlerRequest<
  IRouteHandlerContext = unknown,
  Body = unknown
> {
  incoming: {
    url: string;
